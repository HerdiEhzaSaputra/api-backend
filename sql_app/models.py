...
class Provinsi(Base):
    ...
    kabupatens = relationship("Kabupaten", back_populates="provinsis")
...
class Kabupaten(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    name = Column(String, index=True)
    provinsi_id = Column(Integer, ForeignKey("provinsis.id"))

    provinsis = relationship("Provinsi", back_populates="kabupatens")